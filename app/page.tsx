...
export default function Home() {
  return <div className="flex items-center justify-center h-screen gap-4 flex-col">
    ...
    <div className="flex items-center justify-center flex-col gap-4">
      ...
      <a target="_blank" href="https://www.tinkercad.com/things/f2RGBgmmBta-spectacular-kup/editel" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Tinkercad Link</a>
    </div>
  </div>
}